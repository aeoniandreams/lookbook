(() => {
  ...
  const CUSTOM_ICONS = {
    butterfly: `<path d="M12 5C10.8 3.3 9 2 7 2C4 2 2 4.3 2 7.3C2 10.8 4.3 13 8 13.5C5 14 3 15.8 3 18C3 19.8 4.5 21 6.5 21C9.3 21 11.3 18.7 12 16"/><path d="M12 5C13.2 3.3 15 2 17 2C20 2 22 4.3 22 7.3C22 10.8 19.7 13 16 13.5C19 14 21 15.8 21 18C21 19.8 19.5 21 17.5 21C14.7 21 12.7 18.7 12 16"/>`,
    basketball: `<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2v20"/><path d="M7.5 3.5Q12 12 7.5 20.5"/><path d="M16.5 3.5Q12 12 16.5 20.5"/>`
  };
